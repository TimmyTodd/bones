...
<div class="master-slider ms-skin-default" id="masterslider">
    ...
    <div class="ms-slide slide-1" data-delay="9">
        ...
        <img src="js/masterslider/blank.gif" data-src="http://placehold.it/1920x680" alt=""/>
        ...
        <h5 class="ms-layer text3"
          style="left: 115px; top: 340px;"
            ...
            data-ease="easeOutExpo"
        >
            Many web sites in their infancy various passages ipsum available but the majority <br /> have suffered alteration  versions have evolved over the years.
  ...
  <div class="ms-slide slide-2" data-delay="9">
      ...
      <h3 class="ms-layer text1"
          style="left: 115px; top: 200px;"
            data-type="text"
            data-effect="skewleft(25,90)"
            data-duration="2000"
            data-ease="easeOutQuart"
            data-delay="500"
        >
            Multipage. Onepage Themes
    ...
    <div class="ms-slide slide-3" data-delay="9">
        ...
        <h3 class="ms-layer text1"
          style="left: 115px; top: 200px;"
            data-type="text"
            data-effect="rotate3dleft(50,0,0,270)"
            data-duration="2000"
            data-ease="easeInOutQuint"
        >
            Left &amp; Right Menu Themes
        ...
        <h4 class="ms-layer text2 caps"
          style="left: 115px; top: 255px;"
            data-type="text"
            data-effect="rotate3dright(-50,0,0,270)"
            data-duration="2000"
            data-ease="easeInOutQuint"
        >
            Tons of Features
...
web sites versions have over the years</p>
    ...
    <div class="two_third last">
      ...
      <h4>Very Responsive</h4>
            <p class="smtfont"><a href="">Contact us</a> anytime for quick turnaround and quality support.</p>
...
<div class="container">
    ...
    <div class="one_fourth_less animate" data-anim-type="fadeIn" data-anim-delay="300">
        ...
        <img src="http://placehold.it/275x220" alt="" class="rimg" /> <h4>Responsive Websites</h4>
        <p>Many desktop package web page editors in use the model search many web sites. mEniton wordpress theme devleopemntn</p>
  ...
  <div class="one_fourth_less animate" data-anim-type="fadeIn" data-anim-delay="400">
        ...
        <img src="http://placehold.it/275x220" alt="" class="rimg" /> <h4>HTML5 &amp; Flash Banners</h4>
    ...
    <div class="one_fourth_less active animate" data-anim-type="fadeIn" data-anim-delay="500">
        ...
        <img src="http://placehold.it/275x220" alt="" class="rimg" /> <h4>Email Development</h4>
        <p>For you next campaign. Many desktop package web page editors in use the model search many web sites.</p>
      <a href="#" class="button two">Read More</a>
    ...
    <div class="one_fourth_less last animate" data-anim-type="fadeIn" data-anim-delay="600">
        ...
        <img src="http://placehold.it/275x220" alt="" class="rimg" /> <h4>Website Maintenance/Updates</h4>
        <p>Many desktop package web page editors in use the model search many web sites.</p>
      <a href="#" class="button two">Read More</a>
...
<div class="container">
    ...
    <div class="onecol_forty">
        <img src="<?php echo get_template_directory_uri(); ?>/library/images/site-img5.png" alt="" class="one animate" data-anim-type="fadeInLeft" data-anim-delay="200" />
        <img src="<?php echo get_template_directory_uri(); ?>/library/images/site-img5-2.png" alt="" class="two animate" data-anim-type="fadeInRight" data-anim-delay="200" />
    </div>
...
<div class="container">
  ...
  <div class="one_half left animate" data-anim-type="fadeInLeft" data-anim-delay="100">
      ...
      <img src="http://placehold.it/245x300" alt="Todd Carpenter" />
        
        <br />
        <h4>Todd Carpenter</h4>
    <p class="smtfont">Front End Developer</p>
    ...
    <a href="mailto:todd@toddl.es"><i class="fa fa-envelope-o"></i></a>
    ...
    <div class="one_half right animate" data-anim-type="fadeInRight" data-anim-delay="100">
      ...
      <img src="http://placehold.it/245x300" alt="Elizabeth Carpenter" />
        
        <br />
        <h4>Elizabeth Carpenter</h4>
    <p class="smtfont">Back End Developer</p>
    ...
    <a href="#"><i class="fa fa-google-plus"></i></a>
    <a href="#"><i class="fa fa-linkedin"></i></a>
    <a href="mailto:elizabeth@toddl.es"><i class="fa fa-envelope-o"></i></a>
